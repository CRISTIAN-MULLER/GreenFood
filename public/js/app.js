/******/ ;(() => {
  ...
  \*******************************/
			/***/ (
				...
				/* harmony import */ var noty__WEBPACK_IMPORTED_MODULE_2__ =
					__webpack_require__(/*! noty */ './node_modules/noty/lib/noty.js')
				/* harmony import */ var noty__WEBPACK_IMPORTED_MODULE_2___default =
					/*#__PURE__*/ __webpack_require__.n(noty__WEBPACK_IMPORTED_MODULE_2__)
						...
						return parsedItems
							.map(function (menuItem) {
								return '\n                <p>'
									...
									.concat(menuItem.itemTotalQty, ' ')
									.concat(menuItem.saleUnit.saleUnit, '</p>\n            ')
							})
							.join('')
					}
						...
						return orders
							.map(function (order) {
								return '\n                <tr>\n                <td class="border px-4 py-2 text-green-900">\n                    <p>#'
									.concat(order.orderNumber, '</p>\n                    <div>')
									.concat(
										renderItems(order.items),
										'</div>\n                </td>\n                <td class="border px-4 py-2">',
									)
									.concat(order.customerId.firstName, ' ')
									.concat(
									...
									.concat(
										order.status === 'outfordelivery' ? 'selected' : '',
										'>\n                                    Saiu para entrega\n                                </option>\n                                <option value=\'{"status": "outfordelivery","step" : 4}\' ',
									)
									.concat(
  ...
  \*****************************/
			/***/ (
				...
				/* harmony import */ var noty__WEBPACK_IMPORTED_MODULE_1__ =
					__webpack_require__(/*! noty */ './node_modules/noty/lib/noty.js')
				/* harmony import */ var noty__WEBPACK_IMPORTED_MODULE_1___default =
					/*#__PURE__*/ __webpack_require__.n(noty__WEBPACK_IMPORTED_MODULE_1__)
				/* harmony import */ var _admin__WEBPACK_IMPORTED_MODULE_2__ =
				...
				function updateCart(product) {
					axios__WEBPACK_IMPORTED_MODULE_0___default()
						...
						.then(function (res) {
							...
							cartAmount.innerText = res.data.cartTotalPrice.toLocaleString(
								'pt-BR',
								{
									style: 'currency',
									currency: 'BRL',
				...
				function removeItemFromCart(product) {
					axios__WEBPACK_IMPORTED_MODULE_0___default()
						...
						.then(function (res) {
							var productData = document.getElementById(
								'productData' + res.data.productId,
							)
							console.log(productData)
							productData.remove()
							cartCounter.innerText = res.data.totalQty
							cartAmount.innerText = res.data.itemsTotalPrice.toLocaleString(
								'pt-BR',
								{
									style: 'currency',
									currency: 'BRL',
				...
				addToCartBtn.forEach(function (btn) {
					btn.addEventListener('click', function (e) {
						...
						if (
							hassaleUnitSelected === undefined ||
							hassaleUnitSelected === null
						) {
				...
				decreaseItemQty.forEach(function (btn) {
					btn.addEventListener('click', function (e) {
						var product = JSON.parse(btn.dataset.cart)
						decreaseItemCartQty(product)
					})
				})
				increaseItemQty.forEach(function (btn) {
					btn.addEventListener('click', function (e) {
						var product = JSON.parse(btn.dataset.cart)
				...
				function updateStatus(order) {
					...
					statuses.forEach(function (status) {
						...
						if (dataProp === order.status) {
							stepCompleted = false
							time.innerText = moment__WEBPACK_IMPORTED_MODULE_3___default()(
								order.updatedAt,
							).format('HH:mm')
							status.appendChild(time)
							status.classList.add('current') // if (status.nextElementSibling) {
				...
				socket.on('orderUpdated', function (data) {
					...
					updatedOrder.updatedAt =
						moment__WEBPACK_IMPORTED_MODULE_3___default()().format()
				...
				itemQuantity.forEach(function (input) {
					input.addEventListener('input', function () {
						...
						if (
							...
							$('#totalPrice' + productData._id).text(function () {
								var totalItemprice =
									product.itemTotalQty * product.saleUnit.price
...
*/
				...
				;(function webpackUniversalModuleDefinition(root, factory) {
					...
					return /******/ (function (modules) {
						...
						/******/ __nested_webpack_require_874__.i = function (value) {
							return value
						}
						/******/
						/******/ // define getter function for harmony exports
						/******/ __nested_webpack_require_874__.d = function (
							exports,
							name,
							getter,
						) {
						...
						/******/ __nested_webpack_require_874__.o = function (
							object,
							property,
						) {
						...
						/******/ return __nested_webpack_require_874__(
							(__nested_webpack_require_874__.s = 6),
						)
						/******/
					})(
						/************************************************************************/
						/******/ [
							...
							/***/ function (
								module,
								exports,
								__nested_webpack_require_3313__,
							) {
								'use strict'
							...
							/***/ function (
								module,
								exports,
								__nested_webpack_require_11619__,
							) {
								'use strict'
							...
							/***/ function (
								module,
								exports,
								__nested_webpack_require_21770__,
							) {
								'use strict'
							...
							/***/ function (
								module,
								exports,
								__nested_webpack_require_30823__,
							) {
...
*/
  ...
  */
									...
									exports,
									__nested_webpack_require_30823__(7),
									__nested_webpack_require_30823__(8),
								))
  ...
  \*****************************************/
	...
	;(() => {
		...
		/******/
		/******/ var chunkLoadingGlobal = (self['webpackChunkgreen_food'] =
			self['webpackChunkgreen_food'] || [])
